...
2. **Страница "Мои предпочтения"**: интерфейс для ввода и хранения пользовательских предпочтений.
...
4. Получение рекомендаций (PageRank, CF, kNN).
...
- [x] API для предпочтений (эндпоинты для добавления предпочтений и их получения)
